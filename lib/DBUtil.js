        ...
        if (mongoose.connection.readyState in [mongoose.STATES.connected, mongoose.STATES.connecting]) {
            ...
            if (Apps == null || Execs == null) {
                var AppSchema = new mongoose.Schema({
                    ...
                    type: String, flags: String,
                    license: String, description: String,
                    help: String, installed: Boolean,
                    release_date: {
                        type: Date
                    },
                    updated_at: {
                    ...
                    dependencies: [], gitURL: String,
                    sites: [], gitBranch: String
                });
    ...
    var promise = new Promise((resolve, reject) => {
        ...
        var callback = function(err, data) {
            if (err) {
                ...
                if (data == null) {
                    logger.debug("DBUtil","updateExec","Creating new Exec");
